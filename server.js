...
app.post('/api/v1/admin/licenses/:id/revoke',(req,res)=>setLicenseStatus(req,res,'REVOKED','LICENSE_REVOKED'));
app.post('/api/v1/admin/licenses/:id/suspend',(req,res)=>setLicenseStatus(req,res,'SUSPENDED','LICENSE_SUSPENDED'));
app.post('/api/v1/admin/licenses/:id/reactivate',(req,res)=>setLicenseStatus(req,res,'ACTIVE','LICENSE_REACTIVATED'));
